public class StoreAssistant {
    ...
    public void start(){
        ...
        for(int categoryIndex = 1; categoryIndex < numberOfItems; categoryIndex++) {
            ...
            startQuery(numberOfItems, annualSale, numberOfStores, numberOfMonths);

        }

    }

    private  void  startQuery(int numberOfItems,AnnualSale annualSale, int numberOfStores, int numberOfMonths){
